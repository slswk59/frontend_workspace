	...
	<main role="main">
		...
		<section class="recommend-items_cate">
			...
			<div class="paging_group">
				...
				<a class="paging_atag" href="newList.do?currentPage=1"> <img
				...
				<c:if test="${pv.currentPage>1}">
					<a class="paging_atag"
						href="newList.do?currentPage=${pv.startPage-pv.blockPage}"> <img
					...
					<c:choose>
						<c:when test="${i==pv.currentPage}">
							<a class="paging_atag" style="color: orange;"
								href="newList.do?currentPage=${i}">${i}</a>
						</c:when>
						<c:otherwise>
				...
				<c:if test="${pv.endPage < pv.totalPage}">
					<a class="paging_atag"
						href="newList.do?currentPage=${pv.startPage + pv.blockPage}">
						<img
