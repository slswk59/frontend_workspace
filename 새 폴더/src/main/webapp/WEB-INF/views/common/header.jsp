          ...
          <ul id="userMenu" class="right">
            <li class="menu-item">
              <a
                ...
                class="link_menu"
                ><span id="userMenu1Text">회원가입</span></a
              >
            </li>
            <li class="menu-item">
              <a
        ...
        <div id="menu">
          <nav class="menu">
            <ul class="main-menu">
              <li class="main-menu-item" hidden>
                ...
                <ul class="sub-menu hidden">
                  <li class="sub-menu-item">
                    <a
                      href="${pageContext.request.contextPath}/shopping/ctgProductList.do?category=1"
                  ...
                  <li class="sub-menu-item">
                    <a
                      href="${pageContext.request.contextPath}/shopping/ctgProductList.do?category=2"
                  ...
                  <li class="sub-menu-item">
                    <a
                      href="${pageContext.request.contextPath}/shopping/ctgProductList.do?category=3"
                  ...
                  <li class="sub-menu-item">
                    <a
                      href="${pageContext.request.contextPath}/shopping/ctgProductList.do?category=4"
                  ...
                  <li class="sub-menu-item">
                    <a
                      href="${pageContext.request.contextPath}/shopping/ctgProductList.do?category=5"
                  ...
                  <li class="sub-menu-item">
                    <a
                      href="${pageContext.request.contextPath}/shopping/ctgProductList.do?category=6"
              ...
              <li class="main-menu-item">
                <a href="${pageContext.request.contextPath}/shopping/newList.do"
                  >신상품</a
                >
              </li>
              <li class="main-menu-item">
              ...
              <li class="main-menu-item">
                <a
                  href="${pageContext.request.contextPath}/shopping/salesList.do"
                  >특가</a
                >
              </li>
            </ul>
          ...
          <div>
            <ul class="icons">
              ...
              <li>
                <a href="${pageContext.request.contextPath}/shopping/cart.do">
                  <img
