...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
		...
		String jwtToken = JWT.create()
				...
				.withClaim("authRole", principalDetails.getMembersDTO().getAutoRole())		 //회원 권한
				.withClaim("email", principalDetails.getMembersDTO().getEmail()) //회원 메일
		...
		body.put("email", principalDetails.getMembersDTO().getEmail());
		body.put("authRole", principalDetails.getMembersDTO().getPassWord());
