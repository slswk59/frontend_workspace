    ...
    <>
      ...
      <Container style={{ marginTop: '170px' }}>
        ...
        >
          {/* 드라마 */}
          <div className='item'>
            <input className='checkbox' type='checkbox' id='a1' name='드라마' />
            <label for='a1'>
          ...
          {/* 코믹 */}
          <div className='item'>
            <input className='checkbox' type='checkbox' id='a2' name='코믹' />
            <label for='a2'>
              <div id='drama' className='genre-set'>
                ...
                <p className='genretype'>코믹</p>
              </div>
            </label>
          </div>
          {/* 범죄 */}
          <div className='item'>
            <input className='checkbox' type='checkbox' id='a3' name='범죄' />
            <label for='a3'>
              <div id='drama' className='genre-set'>
          ...
          {/* 로맨스 */}
          <div class='item'>
            <input className='checkbox' type='checkbox' id='a4' name='로맨스' />
            <label for='a4'>
              <div id='drama' className='genre-set'>
          ...
          {/* 액션 */}
          <div class='item'>
            <input className='checkbox' type='checkbox' id='a5' name='액션' />
            <label for='a5'>
              <div id='drama' className='genre-set'>
        ...
        >
          {/* 스릴러 */}
          <div className='item'>
            <input className='checkbox' type='checkbox' id='a6' name='스릴러' />
            <label for='a6'>
              <div id='drama' className='genre-set'>
          ...
          {/* 다큐 */}
          <div class='item'>
            <input className='checkbox' type='checkbox' id='a7' name='다큐' />
            <label for='a7'>
              <div id='drama' className='genre-set'>
          ...
          {/* 모험 */}
          <div class='item'>
            <input className='checkbox' type='checkbox' id='a8' name='모험' />
            <label for='a8'>
              <div id='drama' className='genre-set'>
          ...
          {/* SF */}
          <div class='item'>
            <input className='checkbox' type='checkbox' id='a9' name='SF' />
            <label for='a9'>
              <div id='drama' className='genre-set'>
        ...
        >
          {/* 가족 */}
          <div class='item'>
            <input className='checkbox' type='checkbox' id='a11' name='가족' />
            <label for='a11'>
              <div id='drama' className='genre-set'>
          ...
          {/* 공포 */}
          <div class='item'>
            <input className='checkbox' type='checkbox' id='a13' name='공포' />
            <label for='a13'>
              <div id='drama' className='genre-set'>
          ...
          {/* 전쟁 */}
          <div class='item'>
            <input className='checkbox' type='checkbox' id='a15' name='전쟁' />
            <label for='a15'>
              <div id='drama' className='genre-set'>
        ...
        >
          {/* 음악 */}
          <div class='item'>
            <input className='checkbox' type='checkbox' id='a16' name='음악' />
            <label for='a16'>
              <div id='drama' className='genre-set'>
          ...
          {/* 서부 */}
          <div class='item'>
            <input className='checkbox' type='checkbox' id='a17' name='서부' />
            <label for='a17'>
              <div id='drama' className='genre-set'>
          ...
          {/* 역사 */}
          <div class='item'>
            <input className='checkbox' type='checkbox' id='a18' name='역사' />
            <label for='a18'>
              <div id='drama' className='genre-set'>
